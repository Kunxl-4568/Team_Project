...
export function Search({initialQuery =""}: SearchProps) {
  ...
  <input
    ...
    className="grow p-2 border placeholder:text-[#BDBDBD] placeholder:text-base dark: text-white border-[#2C2C2C] dark:border-white text-base font-slab text-[#2C2C2C] rounded focus:outline-none focus:ring-2 focus:ring-black"
  />
