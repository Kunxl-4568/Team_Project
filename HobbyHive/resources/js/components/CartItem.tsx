            ...
            <div className = 'flex item-center gap-4'>
                ...
                <div>
                    ...
                    <div className='flex gap-2 mt-2'>
                        <button className='px-2 border rounded text-[#2c2c2c] cursor-pointer 'onClick={onDecrease}>-</button>
                        <button className='px-2 border rounded text-[#2c2c2c] cursor-pointer ' onClick={onIncrease}>+</button>
                        <button className='px-2 border rounded text-[#f50000] cursor-pointer ' onClick={onRemove} >REMOVE</button>
                    </div>
                </div>
            </div>
