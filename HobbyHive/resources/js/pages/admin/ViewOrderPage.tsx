...
export default function ViewOrderPage({id}: any){
    const orders = [
        {
            id: "#1234",
            ...
            <div className="">
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                    <div className="p-6 bg-[#fefaf1] rounded-full border flex flex-col items-center transition-transform duration-300 ">
                       <p className="text-[#2c2c2c]"><strong>Date ordered: </strong>{data?.date}</p>
                    </div>
                    
                    <button
                    onClick={() => {
                        if (status === "Pending") setStatus("Completed");
                        else if (status === "Completed") setStatus("Incomplete");
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                    <div className="p-6 bg-[#fefaf1] rounded-full border flex flex-col items-center transition-transform duration-300 ">
                        <p className="text-[#2c2c2c]"><strong>Total: </strong>{data?.total}</p>
                    </div>

                    <div className="p-6 bg-[#fefaf1] rounded-full border flex flex-col items-center transition-transform duration-300 ">
                        <p className="text-[#2c2c2c]"><strong>Billing Address: </strong>{data?.address}</p>
                    </div>
